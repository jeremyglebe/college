...
void cache(){
  ...
  // I really have no idea why it's declared and
  // then immediately changed. I tried to find a reason in the
  // article associated with this code but I'm pretty sure
  // it's just a leftover thing from testing.
  long int size = 32768;
  size = 2048;
...
void openmp(){
  ...
  // I had to drastically reduce maximum size due to
  // memory limitations on the machine I'm using
  // long int size = 32768;
  long int size = 8192;
  int min = 2048;
