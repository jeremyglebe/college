...
export class LevelChooseScene extends Phaser.Scene {
    constructor() {
        super("LevelChoose");
    ...
    preload() {
        ...
        this.load.html('levelchoose', './assets/html/levelchoose.html');
    ...
    create() {
        ...
        this.menuObj = this.add.dom(GAME_SCALE.center.x, GAME_SCALE.center.y).createFromCache('levelchoose');
        ...
        this.menuEle.querySelector('#level_1-button')
            // Buttons have a property "onclick" which should be assigned to a function
            .onclick = () => {
                this.scene.start('Board');
                this.clickSound.play();
            }
            this.menuEle.querySelector('#level_2-button')
            // Buttons have a property "onclick" which should be assigned to a function
            .onclick = () => {
                this.scene.start('Board');
                this.clickSound.play();
            }
            this.menuEle.querySelector('#level_3-button')
            // Buttons have a property "onclick" which should be assigned to a function
            .onclick = () => {
                this.scene.start('Board');
                this.clickSound.play();
            }
            this.menuEle.querySelector('#level_4-button')
            // Buttons have a property "onclick" which should be assigned to a function
            .onclick = () => {
                this.scene.start('Board');
                this.clickSound.play();
            }
            this.menuEle.querySelector('#level_5-button')
            // Buttons have a property "onclick" which should be assigned to a function
            .onclick = () => {
                this.scene.start('Board');
                this.clickSound.play();
